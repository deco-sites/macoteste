...
function CategoryList(props: Props) {
  ...
  return (
    ...
    >
      ...
      <Slider class="carousel carousel-start gap-4 lg:gap-8 row-start-2 row-end-5 items-end">
        {list.map((
          ...
          <Slider.Item
            index={index}
            class="flex flex-col gap-4 carousel-item first:pl-6 sm:first:pl-0 last:pr-6 sm:last:pr-0 self-stretch"
          >
            <a
              href={href}
